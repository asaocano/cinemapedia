...
class HomeViewState extends ConsumerState<HomeView> {
  ...
  Widget build(BuildContext context) {
    ...
    if (initialLoading)
      return FullScreenLoader(); //Si algún provider no se ha terminado de cargar, regresa el widget de cargando
    ...
    CustomScrollView(
      slivers: [
        ...
        SliverAppBar(
          //SliverAppBar será la appbar que tendrá el scrollview
          floating:
